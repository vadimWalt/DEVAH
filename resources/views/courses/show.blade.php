<x-layout> 
    <div class="container mx-auto mt-8 p-8">
        <div class="flex flex-col items-center space-y-4">
            ...
            {{--<div>
                    <ul>
                        <a href="{{ route('chatroom.show') }}">Chatroom</a>
                    </ul>
                    
            </div>--}}

            <div class="flex flex-row justify-end w-full rounded-custom">
                <!-- Chatroom Link -->
                <a href="{{ route('chatroom.show') }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-indigo-600">
                    Chatroom
                </a>
            </div>
...
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto mt-8 p-8 bg-white rounded-lg shadow-md">
        <div class="flex flex-col items-center space-y-4">
            ...
            <div class="flex flex-row justify-end w-full rounded-custom mt-6">
                <a href="{{ route('chatroom.show') }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-indigo-600">
                    Chatroom
                </a>
            </div>
